<?php
    ...
    $sql  = "SELECT courseName FROM faculty JOIN faculty_courses_taken ON faculty_courses_taken.facultyId=faculty.facultyId JOIN courses ON courses.courseId=faculty_courses_taken.courseId WHERE faculty.facultyId='$id'";
