...
{
	$_SESSION[qn]=0;
	mysqli_query($con,"delete from exam_useranswer where sess_id='" . session_id() ."'") or die(mysqli_error());
	$_SESSION[trueans]=0;
...
{	
		...
		else if($submit=='Get Result' && isset($ans))
		{
				...
				echo "</table>";
				mysqli_query($con,"insert into exam_result(login,test_id,test_date,score) values('$login',$tid,'".date("d/m/Y")."',$_SESSION[trueans])") or die(mysqli_error());
