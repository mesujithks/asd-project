...
$query="SELECT * FROM `notice` WHERE `course` IN (SELECT crsId FROM student_courses_taken WHERE stdId=$_SESSION[user_id]) UNION SELECT * FROM `notice` WHERE `course`=0 ORDER BY `Date` DESC";
