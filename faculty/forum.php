...
$query="SELECT * FROM `courses`,discussion_subtopic WHERE discussion_subtopic.topic_id=courses.courseId AND courses.courseId IN (SELECT courseId FROM faculty_courses_taken WHERE facultyId=$fid) GROUP BY courses.courseName";
