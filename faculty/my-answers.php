...
$query="SELECT * from  discussion_answer,discussion_question where discussion_answer.user_id=$fid and discussion_answer.question_id=discussion_question.question_id ORDER BY discussion_answer.datetime desc";
