...
<ol class="breadcrumb w3-card-2">
    <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i><a href="index.php?page=my-course">My Courses</a><i class="fa fa-angle-right"></i><a href="index.php?page=course-view&id=<?php echo $id; ?>"><?php echo $cname; ?></a><i class="fa fa-angle-right"></i>Add/Edit Questions</li>
</ol>
